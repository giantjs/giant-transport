...
(function () {
    ...
    test("Instantiation", function () {
        var serviceEvent = giant.FileEvent.create('foo', $event.eventSpace);
    ...
    test("Event surrogate", function () {
        ok($event.Event.create('file.foo', $event.eventSpace).isA(giant.FileEvent), "should return FileEvent instance");
    });

    test("Spawning event", function () {
        ok($event.eventSpace.spawnEvent('file.foo').isA(giant.FileEvent), "should return FileEvent instance");
    });

    test("File path setter", function () {
        var filePath = 'foo/bar'.toFilePath(),
            fileEvent = giant.FileEvent.create('foo', $event.eventSpace);
    ...
    test("Cloning", function () {
        var error = new Error(),
            data = {},
            imageEvent = giant.FileEvent.create('foo', $event.eventSpace)
