(function () {
    ...
    test("Instantiation", function () {
        var serviceEvent = $transport.ServiceEvent.create('foo', $event.eventSpace);
    ...
    test("Event surrogate", function () {
        ok($event.Event.create('service.foo', $event.eventSpace).isA($transport.ServiceEvent), "should return ServiceEvent instance");
    });

    test("Spawning event", function () {
        ok($event.eventSpace.spawnEvent('service.foo').isA($transport.ServiceEvent), "should return ServiceEvent instance");
    });

    test("Request setter", function () {
        var request = 'foo/bar'.toRequest(),
            serviceEvent = $transport.ServiceEvent.create('foo', $event.eventSpace);
    ...
    test("Cloning", function () {
        ...
        ok(result.isA($transport.ServiceEvent), "should return ServiceEvent instance");
