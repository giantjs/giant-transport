...
(function () {
    ...
    test("Instantiation", function () {
        var serviceEvent = giant.ServiceEvent.create('foo', $event.eventSpace);
    ...
    test("Event surrogate", function () {
        ok($event.Event.create('service.foo', $event.eventSpace).isA(giant.ServiceEvent), "should return ServiceEvent instance");
    });

    test("Spawning event", function () {
        ok($event.eventSpace.spawnEvent('service.foo').isA(giant.ServiceEvent), "should return ServiceEvent instance");
    });

    test("Request setter", function () {
        var request = 'foo/bar'.toRequest(),
            serviceEvent = giant.ServiceEvent.create('foo', $event.eventSpace);
